...
export class DialogRegistraContactoComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialogRegistraContactoComponent>, private _ngZone: NgZone, private firestoreService: FirestoreService, 
  ...
  saveIniciativa(){
    ...
    iniciativaObject.numeroIniciativa = this.regContacto.value.numIniciativaInput;
    iniciativaObject.estado = this.regContacto.value.estadoSelect as ParametroDetalleFire;
    iniciativaObject.titulo = this.regContacto.value.tituloInput;
    iniciativaObject.jefeProyecto = this.regContacto.value.jefeProyectoSelect as ColaboradorDetalleFire;
    iniciativaObject.sumilla = this.regContacto.value.sumillaInput;
    iniciativaObject.usuarioProcesos = this.regContacto.value.usuarioProcesosSelect as ColaboradorDetalleFire;
    
    iniciativaObject.objetivoPrincipal = this.regContacto.value.objPrincipalTextArea;
    
    iniciativaObject.objetivoSecundario = this.regContacto.value.objSecundarioTextArea;
    
    iniciativaObject.fechaInicio = this.regContacto.value.fechaInicioInput;
    
    iniciativaObject.horaEstimada = this.regContacto.value.horaEstimadaInput;
    
    iniciativaObject.fechaFin = this.regContacto.value.fechaFinInput;
   
    iniciativaObject.prioridad = this.panelColor.value as ParametroDetalleFire;
    
    iniciativaObject.clasificacion = this.regContacto.value.clasificacionSelect as ParametroDetalleFire;
   
    iniciativaObject.area = this.regContacto.value.areaSelect as ParametroDetalleFire;
   
    iniciativaObject.categoria = this.regContacto.value.categoriaSelect as ParametroDetalleFire;
    
    iniciativaObject.tipo = this.regContacto.value.tipoSelect as ParametroDetalleFire;
